...
st.set_page_config(page_title="AirBnb-Analysis by Gayathri!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\Gayathri\OneDrive\Desktop\proj4")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Gayathi"}')
    mail = (f'{"Mail :"}  {"gaya.raga97@gmailcom"}')
    description = "A Data enthusiast..!"
    social_media = {

        "GITHUB":"https://github.com/dashboard"}

    col1, col2 = st.columns(2)
    col1.image(Image.open("airbnb.png"), width=300)

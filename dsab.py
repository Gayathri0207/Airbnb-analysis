...
image1=Image.open("C:\\Users\\Gayathri\\OneDrive\\Desktop\\proj4\\airbnb.png")
st.image(image1)
...
@st.cache_resource
def df_airbnb():
    df=pd.read_csv("C:\\Users\\Gayathri\\OneDrive\\Desktop\\proj4\\Airbnb1.csv")
    return df
...
if selected=="Home":
    ...
    ex=pd.read_csv("C:\\Users\\Gayathri\\OneDrive\\Desktop\\proj4\\Airbnb1.csv")
...
if selected=="About":
    ...
    st.link_button(":black[GitHub]","https://github.com/Gayathri0207")
